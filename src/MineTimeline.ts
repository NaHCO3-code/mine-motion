...
import { MinePluse, MineTimelineConfig } from "./Interfaces";
...
export class MineTimeline {
  ...
  constructor(config: MineTimelineConfig){
    this.pluseSource = config.pluseSource ?? MineTimeline.defaultPluseSource;
  }
...
MineTimeline.enableInnerInterval();